...
<style>
		...
		.wpsm_ac_h_i{
			background:url('<?php echo wpsm_mmr_PLUGIN_URL.'img/slide6-min.jpg'; ?>') 50% 0 repeat fixed;
...
<div class="wpsm_buy_tab" role="tabpanel">
                ...
                <ul class="wpsm_buy_nav wpsm_buy_nav-tabs" role="tablist">
                    <li ><a target="_blank" href="https://wordpress.org/support/plugin/maintenance-mode-page/" ><i class="fa fa-question"></i>Need Help</a></li>
